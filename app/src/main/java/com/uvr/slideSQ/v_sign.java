...
public class v_sign extends AppCompatActivity  {
    String answer = "yes";
    int count = 0;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.v_sign);
        ...
        CountDownTimer countDownTimer = new CountDownTimer(600000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(v_sign.this, "제한시간 초과", Toast.LENGTH_SHORT).show();
            }
        }.start();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(v_sign.this, game_main2.class));
            }
        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (count >= 4) {
                    startActivity(new Intent(v_sign.this, game_finish.class));
                } else {
                    startActivity(new Intent(v_sign.this, game_finish2.class));
                }
