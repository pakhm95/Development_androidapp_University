...
public class b_trens_main extends AppCompatActivity  {
    String answer = "yes";
    int count = 0;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_trens_main);
        ...
        CountDownTimer countDownTimer = new CountDownTimer(600000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(b_trens_main.this, "제한시간 초과", Toast.LENGTH_SHORT).show();
            }
        }.start();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(b_trens_main.this, game_main2.class));
            }
        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (count >= 8) {
                    startActivity(new Intent(b_trens_main.this, game_finish.class));
                } else {
                    startActivity(new Intent(b_trens_main.this, game_finish2.class));
                }
